...
namespace TestApiBinding.Common
{
    public class SimplePostVariableParameterBinding : HttpParameterBinding
    {
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            if (stringValue == null)
            {
                ...
                if (query != null)
                {
                    ...
                    if (keyValuePairs.Any()) stringValue = keyValuePairs.First().Value;
                }
            }
        ...
        public static HttpParameterBinding HookupParameterBinding(HttpParameterDescriptor descriptor)
        {
                ...
                supportedMethods.Contains(HttpMethod.Put))
            {
                ...
                // Only apply this binder on simple types
        ...
        /// <summary>
        /// Converts a string value that read form request body to simple type
        /// </summary>
        ...
        private object StringToType(string stringValue)
        {
            ...
            {
                value = string.IsNullOrWhiteSpace(stringValue) ? (int?)null : int.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            else if (Descriptor.ParameterType == typeof(long))
            {
                value = long.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            else if (Descriptor.ParameterType == typeof(long?))
            {
                value = string.IsNullOrWhiteSpace(stringValue) ? (long?)null : long.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            ...
            {
                value = string.IsNullOrWhiteSpace(stringValue) ? (decimal?)null : decimal.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            ...
            {
                value = string.IsNullOrWhiteSpace(stringValue) ? (double?)null : double.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            ...
            {
                value = string.IsNullOrWhiteSpace(stringValue) ? (DateTime?)null : DateTime.Parse(stringValue, CultureInfo.CurrentCulture);
            }
            ...
            else if (Descriptor.ParameterType == typeof(bool?))
            {
                ...
                else if (stringValue.Equals("true", StringComparison.OrdinalIgnoreCase) || stringValue.Equals("on", StringComparison.OrdinalIgnoreCase) || stringValue == "1") value = true;
            }
            else
            {
                value = stringValue;
